    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'insurer_code', type: 'varchar', length: '100', isNullable: true },
          ...
          { name: 'insured_tax_id', type: 'varchar', length: '20', isNullable: true },
          { name: 'beneficiary_name', type: 'varchar', length: '255', isNullable: true },
          ...
          { name: 'rate_percent', type: 'decimal', precision: 6, scale: 4, isNullable: true },
          ...
          { name: 'last_reminder_sent_at', type: 'timestamp with time zone', isNullable: true },
          { name: 'agent_name', type: 'varchar', length: '100', isNullable: true },
          { name: 'agent_phone', type: 'varchar', length: '50', isNullable: true },
          { name: 'agent_email', type: 'varchar', length: '255', isNullable: true },
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'min_rate', type: 'decimal', precision: 6, scale: 4, isNullable: true },
          { name: 'max_rate', type: 'decimal', precision: 6, scale: 4, isNullable: true },
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'status', type: 'varchar', length: '50', default: "'generated'" },
          { name: 'disposer_name', type: 'varchar', length: '255', isNullable: true },
          { name: 'disposer_license_no', type: 'varchar', length: '20', isNullable: true },
          { name: 'disposal_facility', type: 'varchar', length: '255', isNullable: true },
          { name: 'transporter_name', type: 'varchar', length: '255', isNullable: true },
          { name: 'vehicle_plate', type: 'varchar', length: '20', isNullable: true },
          { name: 'transport_date', type: 'timestamp with time zone', isNullable: true },
          { name: 'disposal_method', type: 'varchar', length: '100', isNullable: true },
          { name: 'disposal_date', type: 'timestamp with time zone', isNullable: true },
          { name: 'manifest_number', type: 'varchar', length: '50', isNullable: true },
          { name: 'manifest_submitted', type: 'boolean', default: false },
          { name: 'manifest_submitted_at', type: 'timestamp with time zone', isNullable: true },
          { name: 'is_recyclable', type: 'boolean', default: false },
          { name: 'recycled_quantity', type: 'decimal', precision: 10, scale: 2, isNullable: true },
          { name: 'recycler_name', type: 'varchar', length: '255', isNullable: true },
          { name: 'disposal_cost', type: 'decimal', precision: 12, scale: 2, isNullable: true },
          { name: 'transport_cost', type: 'decimal', precision: 12, scale: 2, isNullable: true },
          { name: 'generation_location', type: 'varchar', length: '255', isNullable: true },
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'total_disposal_cost', type: 'decimal', precision: 12, scale: 2 },
          { name: 'total_transport_cost', type: 'decimal', precision: 12, scale: 2 },
          { name: 'overall_recycle_rate', type: 'decimal', precision: 5, scale: 2 },
          { name: 'status', type: 'varchar', length: '50', default: "'draft'" },
          { name: 'submitted_at', type: 'timestamp with time zone', isNullable: true },
          { name: 'epa_report_number', type: 'varchar', length: '100', isNullable: true },
          { name: 'created_at', type: 'timestamp with time zone', default: 'now()' },
          { name: 'updated_at', type: 'timestamp with time zone', default: 'now()' },
        ],
      }),
