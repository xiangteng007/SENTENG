...
import { ExportSmartHomeDto, ExportSmartHomeResponseDto } from './dto/export-smart-home.dto';
...
export class SmartHomeController {
  ...
  async findAll(@Query() query: SmartHomeQueryDto): Promise<SmartHomeProduct[]> {
  ...
  async exportToGoogleSheets(
    ...
    return this.smartHomeService.exportToGoogleSheets(userId, dto.items, dto.options);
  }
}
