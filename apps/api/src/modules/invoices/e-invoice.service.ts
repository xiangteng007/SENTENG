...
export class EInvoiceService {
  ...
  private getBaseURL(): string {
    if (this.provider === 'ecpay') {
      ...
      return this.isProduction ? 'https://inv.ezpay.com.tw/Api' : 'https://cinv.ezpay.com.tw/Api';
    }
  }
  ...
  private async issueECPayInvoice(dto: InvoiceIssueDto): Promise<InvoiceResult> {
  ...
  private async issueEzPayInvoice(dto: InvoiceIssueDto): Promise<InvoiceResult> {
    ...
    const itemAmounts = dto.items.map(i => i.quantity * i.unitPrice).join('|');
